...
{ id:"deeds", title:"Good Deeds", count:26, trophy:"Man of the People", items:[
 ...
 {id:"gd10", name:"Heart of Gold", zone:"Vyssa Hills", zones:["Vyssa Hills"], miss:true, campaignId:"b2", detail:"Keys – ON Vehicle drop from the Vyssa Timeloop; give to Atticus only AFTER Good Deeds 11 and 12."},
 {id:"gd11", name:"On Death's Door", zone:"Vyssa Hills", zones:["Vyssa Hills"], miss:true, campaignId:"a12", detail:"Pill Bottle – Atenolol by the rock pile near Vitalis' grave → woman at the north camp. Deadline: end of Act 1, and strictly before GD10."},
 {id:"gd12", name:"Man's Best Friend", zone:"Acasa → Vyssa Hills", zones:["Acasa Marshes", "Vyssa Hills"], miss:true, campaignId:"b1", detail:"Act 2 start: free the dog west of Jova → Dog Collar to the man at the Vyssa refugee camp. Complete before the abbey events so the dog reaches the lake (Ever After)."},
 ...
 {id:"gd21", name:"A Way Out", zone:"Lethe Library + Ministry", zones:["Lethe – Library", "Lethe – Ministry"], miss:false, campaignId:null, detail:"Note in the Restoration Office starts it; Ministry Office 109 safe (code 2703) → Official Hadean Stamp; Office 112 → Blank ID Cards; both to the old lady in the Library basement."},
 ...
 {id:"gd23", name:"Mementos", zone:"Auriga Museum → Marastan + Senedra", zones:["Senedra Forest", "Marastan", "Auriga Museum"], miss:false, campaignId:null, detail:"Cigarette Case + Ring from Cells 002/004 past the Training Room vault door; Case → Elzina Tibor at the Marastan boat-dock house (requires GD19 done); Ring → Dag Samson in Caddel's basement."},
 ...
 {id:"gd25", name:"Never Worn", zone:"Jeljin → Acasa", zones:["Acasa Marshes", "Jeljin"], miss:false, campaignId:null, detail:"Key – Archeology Camp by the dig-site Timeloop backpack → locker in the small camp tent → Shoes – Red placed at the elephant plush upstairs in the Jova graffiti house."},
...
{ id:"relics", title:"Relics", count:29, trophy:"Antiquarian", items:[
 {id:"rl1", name:"Aarlon's Last Stand", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Mystery #7: The Hermit."},
 ...
 {id:"rl4", name:"Call of the Griffon", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:true, campaignId:null, detail:"Reward for Good Deed #3: Land of Milk and Honey (via Gildas). Missable with the deed."},
 ...
 {id:"rl8", name:"Knell of Ebbing Ecstasy", zone:"Talju", zones:["Talju"], miss:true, campaignId:null, detail:"Reward for Good Deeds #13–16: A Light in the Dark (via Gildas). Missable with the deeds."},
 {id:"rl9", name:"Knell of Fading Terror", zone:"Marastan", zones:["Marastan"], miss:false, campaignId:null, detail:"Reward for Good Deed #19: The Depths of Hell (via Gildas). See GD19's ordering caution."},
 ...
 {id:"rl16", name:"The Benediction of Palom", zone:"Museum → Marastan/Senedra", zones:["Senedra Forest", "Marastan", "Auriga Museum"], miss:false, campaignId:null, detail:"Reward for Good Deed #23: Mementos (via Gildas)."},
 ...
 {id:"rl18", name:"The Bloodseeker", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Mystery #11: The Protector (abbey Timeloop → Jova cemetery pillar)."},
 {id:"rl19", name:"The Crucible of Fire", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Mystery #12: Enlightenment — pick it up from the opened room."},
 ...
 {id:"rl24", name:"The Omen of Oblivion", zone:"Senedra Forest", zones:["Senedra Forest"], miss:false, campaignId:null, detail:"Close Timeloop – Senedra Hilltop → Gildas (requires Mystery #3 to reach)."},
 {id:"rl25", name:"The Panoptic Eudemon", zone:"Lake Cynon → Acasa", zones:["Lake Cynon", "Acasa Marshes"], miss:false, campaignId:null, detail:"Mystery #22: Safekeeping."},
 {id:"rl26", name:"The Relentless Assault", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:true, campaignId:null, detail:"Reward for Good Deed #7: Waylaid (via Gildas). Missable with the deed."},
 ...
 {id:"rl28", name:"Visage of the Defier", zone:"Jeljin", zones:["Jeljin"], miss:false, campaignId:null, detail:"Mystery #38: Family First — pick up from the opened room."},
...
{ id:"myst", title:"Mysteries", count:43, trophy:"Super-Sleuth", items:[
 ...
 {id:"my3", name:"Lymbic Door – Senedra, Hilltop", zone:"Senedra Forest", zones:["Senedra Forest"], miss:false, campaignId:null, detail:"Grief rods from the Vigil Hideout coffin room and the Francis' Church mine (needs Key – Mine); door at the hilltop ruins. Gates Timeloop #1."},
 {id:"my4", name:"Lymbic Door – Senedra, Underground", zone:"Senedra Forest", zones:["Senedra Forest"], miss:false, campaignId:null, detail:"Rage rods from the Talju circled house (Key – Talju House at the playground) and the Marastan cave; door in the GD2 room."},
 ...
 {id:"my13", name:"Lymbic Chest – Acasa, Vitalis' Basement", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Grief rods from Vitalis' basement and behind Victor's red chest; chest back in the basement."},
 {id:"my14", name:"Lymbic Door – Acasa, Western Monument", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Neutral rods from the Jova well hallway and the ruins north of the hanging tree; door under the marsh stone tower."},
 {id:"my15", name:"Lymbic Chest – Acasa, Eastern Ruins", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Terror rod beside the Pathem Abbey Timeloop; green chest in the ruins north of the tall pillars."},
 {id:"my16", name:"Lymbic Chest – Vyssa Hills, Fort", zone:"Vyssa Hills", zones:["Vyssa Hills"], miss:false, campaignId:null, detail:"Ecstasy rod up the steps after the Francis' Church events; yellow chest by the Moon-door ruins."},
 ...
 {id:"my20", name:"Lymbic Chest – Lake Cynon, Reservoir", zone:"Lake Cynon", zones:["Lake Cynon"], miss:false, campaignId:null, detail:"Neutral rods (Acasa blocked road body; Outpost 08 left tent); white chest opposite the forge entrance in the drained reservoir."},
 ...
 {id:"my22", name:"Safekeeping", zone:"Lake Cynon → Acasa", zones:["Lake Cynon", "Acasa Marshes"], miss:false, campaignId:null, detail:"Key – Rustic behind Rebecca's lake building (post-abbey) → chest opposite the Pathem Abbey entrance. Awards Relic: The Panoptic Eudemon."},
 {id:"my23", name:"Lymbic Door – Lymbic Forge", zone:"Lymbic Forge", zones:["Lymbic Forge"], miss:false, campaignId:null, detail:"Three Terror rods inside the forge (below the pillar room; by the drain-mechanism walkway; west lockdown room); door at the lowest drained level."},
 {id:"my24", name:"Lymbic Chest – Lymbic Forge, Hall", zone:"Lymbic Forge", zones:["Lymbic Forge"], miss:false, campaignId:null, detail:"Rage rod in the podium library; chest through the Owl-key door off the torch room."},
 {id:"my25", name:"Lymbic Chest – Lymbic Forge, Dormitory", zone:"Lymbic Forge", zones:["Lymbic Forge"], miss:false, campaignId:null, detail:"Neutral rod in the second library room; chest in the dormitory up the northern stairs past the sigil door."},
 ...
 {id:"my27", name:"History Lesson", zone:"Talju (safe at Lethe Library)", zones:["Talju", "Lethe – Library"], miss:false, campaignId:null, detail:"Safe on the trash can by the Library entrance gate: code 81643."},
 ...
 {id:"my30", name:"Lymbic Chest – Marastan, Ruins", zone:"Marastan", zones:["Marastan"], miss:false, campaignId:null, detail:"Terror rod in the crypt's south hall east alcove; chest atop the island ruins past the wooden bridge tunnel."},
 ...
 {id:"my39", name:"Lymbic Chest – Jeljin, Archeology Camp", zone:"Jeljin", zones:["Jeljin"], miss:false, campaignId:null, detail:"Rage rods (Ministry white truck east of APC; dig-site save-point flower room); red chest on the dig-site truck."},
 ...
 {id:"my41", name:"Lymbic Chest – Lymbic Forge, Waterfall", zone:"Museum → Lymbic Forge", zones:["Lymbic Forge", "Auriga Museum"], miss:false, campaignId:null, detail:"Grief rod in the same B4 storage room; blue chest behind the waterfall between the Keystone-room waterwheels."},
...
{ id:"loops", title:"Timeloops", count:14, trophy:"End the Suffering → Legend of the Phol", items:[
 {id:"tl1", name:"Senedra – Hilltop", zone:"Senedra Forest", zones:["Senedra Forest"], miss:false, campaignId:null, detail:"Prism: Sigma. Reach via Mystery #3. Stragglers: start-of-game underground, OMSIF camp, Arcas Spire path, forest between APC and Caddel's house."},
 {id:"tl2", name:"Senedra – Arcas Spire", zone:"Arcas Spire", zones:["Arcas Spire"], miss:false, campaignId:null, detail:"Story-required (Keystone of Terror). Stragglers: cell Hollows in the plate/lever room — plates marked 4 open each section's cells."},
 {id:"tl3", name:"Acasa Marshes", zone:"Acasa Marshes", zones:["Acasa Marshes"], miss:false, campaignId:null, detail:"Prism: Sigma. East of Jova past the bridge. Stragglers: enemies hidden in the shallow marsh pools (walk through to trigger), tunnels under Jova, Victor's rescue tunnel."},
 ...
 {id:"tl5", name:"Vyssa Hills", zone:"Vyssa Hills", zones:["Vyssa Hills"], miss:false, campaignId:null, detail:"Prism: Sigma. Center of the area by the mine entrance. Stragglers: mine tunnels + hilltop entrance, lower water pools — and the hidden mine room (ladder down, first left) from the trophy-guide comments."},
 ...
 {id:"tl7", name:"Lake Cynon – Lymbic Forge", zone:"Lake Cynon", zones:["Lymbic Forge"], miss:false, campaignId:null, detail:"Prism: Theta. Bottom of the Act 1 elevator. Stragglers: story side paths, check dead ends."},
 {id:"tl8", name:"Lake Cynon – Sphere Antechamber", zone:"Lake Cynon", zones:["Lake Cynon"], miss:false, campaignId:null, detail:"Story-required in Act 3; no Gildas reward."},
 {id:"tl9", name:"Talju", zone:"Talju", zones:["Talju"], miss:false, campaignId:null, detail:"Prism: Theta. NW corner past the barn. Stragglers: north/south edge paths, garage by the APC."},
 {id:"tl10", name:"Marastan", zone:"Marastan", zones:["Marastan"], miss:false, campaignId:null, detail:"Prism: Theta. West ruins, hug the left wall into the forest. Stragglers: forest paths east of APC, church crypt, Blood Queen statue caves."},
